...
impl From<yolov5cv::YoloDetection> for CamTrapDetection {
    fn from(yolo: yolov5cv::YoloDetection) -> Self {
        Self {
            x: yolo.x,
            y: yolo.y,
            width: yolo.width,
...
impl From<yolov5cv::YoloImageDetections> for CamTrapImageDetections {
    fn from(yolo: yolov5cv::YoloImageDetections) -> Self {
